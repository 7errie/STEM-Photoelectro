...
export const tabObjOne = {
    id: null,
    content: [
      "<p><span style=\"color: #000; font-size: larger;\">Global demand of energy</span> has become an important issue all over the world as we now face problem of <span>lack of energy supply</span>. discovered that <span>hydrogen fuel</span> has the potential to be a solution to these <span>environmental problems, clean and abundant</span> energy source, has <span>excellent energy conversion efficiency</span> and can converts into a variety of energy forms. However, this hydrogen energy comes from fossil fuels, which are finite, non-renewable, unsustainable and classified as grey and blue hydrogen. To address this problem, production, storage, and end-use goods of hydrogen must be ecologically benign, with renewable energy sources being used to generate this energy carrier, which is called as <span>green hydrogen</span>.</p>", 
      "<h4>Difference between grey, blue and green hydrogen</h4><br /><p>Grey hydrogen is created from natural gas, or methane, using steam methane reformation but without capturing the greenhouse gases made in the process. Blue hydrogen uses carbon capture and storage for the greenhouse gases produced in the creation of grey hydrogen <span>Green hydrogen is made with water electrolysis</span>, and energy derived from <span>renewable sources</span> such as solar and wind</p><br />", 
